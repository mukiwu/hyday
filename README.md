...
| 平台 | 說明 | 下載 |
|------|------|------|
| macOS | Apple M 系列晶片 | [Hyday-0.0.6-arm64.dmg](https://github.com/mukiwu/hyday/releases/download/v0.0.6/Hyday-0.0.6-arm64.dmg) |
| macOS | Intel (x64) | [Hyday-0.0.6.dmg](https://github.com/mukiwu/hyday/releases/download/v0.0.6/Hyday-0.0.6.dmg) |
| Windows | x64 | [Hyday Setup 0.0.6.exe](https://github.com/mukiwu/hyday/releases/download/v0.0.6/Hyday.Setup.0.0.6.exe) |

### macOS 使用者注意

由於應用程式未經 Apple 公證，macOS 會阻止開啟。請在 Terminal 執行以下指令解除隔離：

```bash
xattr -cr /Applications/Hyday.app
```
